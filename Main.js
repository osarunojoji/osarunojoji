...
var u = "lua";
var MAXvalue = 999;
let offsetFunction = "local offSET = {}br999function offset(addrs, type, editVal)br999if gg.getResultsCount() == 0 thenbr999gg.alert("+n+"後藤する値が見つかりません"+n+")br999elsebr999offset = gg.getResults(1)br999offSET[1] = {}br999offSET[1].address = offset[1].address - addrsbr999offSET[1].flags = typebr999offSET[1].value = editValbr999gg.setValues(offSET)br999endbr999endbr999";
status = 1;
makevalue = 1;//表示
judgevalue = 1;
memoryValue=1;
